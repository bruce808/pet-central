    ...
    items: [
      {
        label: 'Cases',
        href: '/cases',
        icon: <Icon d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 0 0 .75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 0 0-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0 1 12 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 0 1-.673-.38m0 0A2.18 2.18 0 0 1 3 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 0 1 3.413-.387m7.5 0V5.25A2.25 2.25 0 0 0 13.5 3h-3a2.25 2.25 0 0 0-2.25 2.25v.894m7.5 0a48.667 48.667 0 0 0-7.5 0" />,
      },
      {
        label: 'Moderation Queue',
        href: '/moderation',
        icon: <Icon d="M3 3v1.5M3 21v-6m0 0 2.77-.693a9 9 0 0 1 6.208.682l.108.054a9 9 0 0 0 6.086.71l3.114-.732a48.524 48.524 0 0 1-.005-10.499l-3.11.732a9 9 0 0 1-6.085-.711l-.108-.054a9 9 0 0 0-6.208-.682L3 4.5M3 15V4.5" />,
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        label: 'Verifications',
        href: '/organizations?tab=verifications',
    ...
    items: [
      {
        ...
        href: '/ai/correspondence',
        icon: <Icon d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" />,
      },
      {
        label: 'Discovery',
        href: '/ai/discovery',
        icon: <Icon d="M7.5 3.75H6A2.25 2.25 0 0 0 3.75 6v1.5M16.5 3.75H18A2.25 2.25 0 0 1 20.25 6v1.5m0 9V18A2.25 2.25 0 0 1 18 20.25h-1.5m-9 0H6A2.25 2.25 0 0 1 3.75 18v-1.5M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />,
      },
    ],
  },
  {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-4 z-50 rounded-[10px] bg-white p-2 shadow-card border border-gray-200 text-gray-700 md:hidden"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-64 flex-col bg-white border-r border-gray-200 transition-transform duration-300 md:translate-x-0 ${
      ...
      >
            ...
            <div key={section.title} className="mb-5">
              ...
              {section.items.map((item) => (
                <Link
                  ...
                  href={item.href}
                  onClick={() => setMobileOpen(false)}
                  className={`flex items-center gap-2.5 rounded-[10px] px-2.5 py-2 text-sm transition-colors ${
                    isActive(item.href)
        ...
        <div className="border-t border-gray-100 px-5 py-3">
          <p className="text-xs text-gray-400">PetCentral Admin v0.0.1</p>
        </div>
      </aside>
    </>
  );
