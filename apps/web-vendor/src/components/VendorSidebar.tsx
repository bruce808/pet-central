...
const navItems = [
  ...
  { label: 'Documents', href: '/organization/documents', icon: DocumentsIcon },
  { label: 'Members', href: '/organization/members', icon: MembersIcon },
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-[10px] px-3 py-2.5 text-sm font-medium transition-all duration-150 ${
                active
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-4 z-40 rounded-[10px] bg-white p-2 shadow-card border border-gray-200 lg:hidden"
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          <div
            ...
            onClick={() => setMobileOpen(false)}
          />
          <div className="animate-slide-in-right relative">{sidebar}</div>
        </div>
      )}
    </>
  );
